...
def process_request(request):
	...
	return templater.render_to_response(request, 'accountInfo.html', params)
...
def edit(request):
	...
	params['form'] = form
	params['user'] = user
	return templater.render_to_response(request, 'accountInfo.edit.html', params)
...
def create(request):
	...
	return HttpResponseRedirect('/homepage/accountInfo.edit/{}'.format(user.id))
